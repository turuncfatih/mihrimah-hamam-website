...
const FAQS: Record<Lang, Faq[]> = {
  tr: [
    ...
    { q: 'Ne kadar sürüyor?', a: 'Süre seçtiğiniz pakete ve size göre değişir. Sonrasında dinlenme süresi sınırsızdır.' },
  ...
  en: [
    ...
    { q: 'How long does it take?', a: 'It depends on the package you choose and on you. Resting afterwards is unlimited.' },
  ...
  ar: [
    ...
    { q: 'كم يستغرق الوقت؟', a: 'يختلف ذلك حسب الباقة التي تختارها وحسب رغبتك. أما الراحة بعدها فغير محدودة.' },
  ...
  ru: [
    ...
    { q: 'Сколько это занимает?', a: 'Зависит от выбранного пакета и от вас. Отдых после процедуры не ограничен.' },
  ...
  es: [
    ...
    { q: '¿Cuánto dura?', a: 'Depende del paquete que elijas y de ti. El descanso posterior es ilimitado.' },
